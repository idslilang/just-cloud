...
import com.cloud.just.common.core.util.ResourceUtils;
...
public class MenuController {
	...
	public R getUserMenu(Integer parentId) {
		// 获取符合条件的菜单
		if (!CollectionUtils.isEmpty(StpUtil.getRoleList())) {
			Set<SysMenu> sysMenuList = sysMenuService.findMenuByRoleId(CollUtil.join(ResourceUtils.getRoleIds(StpUtil.getRoleList()), StrUtil.COMMA));
			return R.ok(sysMenuService.filterMenu(sysMenuList, parentId));
		}
		return R.failed("请创建账户角色");
	}
