...
package com.cloud.just.common.security.feign;
 ...
 */
@Slf4j
public class JustFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public JustFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
