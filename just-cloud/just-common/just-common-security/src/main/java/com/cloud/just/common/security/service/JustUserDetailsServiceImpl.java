...
package com.cloud.just.common.security.service;
...
public class JustUserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) {
		...
		if (cache != null && cache.get(username) != null) {
			return (JustUser) cache.get(username).get();
		}
	...
	private UserDetails getUserDetails(R<UserInfo> result) {
		...
		// 构造security用户
		return new JustUser(user.getUserId(), user.getDeptId(), user.getUsername(),
