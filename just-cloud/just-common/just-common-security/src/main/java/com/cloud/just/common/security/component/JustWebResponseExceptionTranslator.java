...
import com.cloud.just.common.security.exception.*;
 ...
 */
@Slf4j
public class JustWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new JustAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
