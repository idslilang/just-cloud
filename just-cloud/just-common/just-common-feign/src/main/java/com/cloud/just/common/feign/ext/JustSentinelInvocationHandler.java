 ...
 */
@Slf4j
public class JustSentinelInvocationHandler implements InvocationHandler {
	...
	JustSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			JustSentinelInvocationHandler other = (JustSentinelInvocationHandler) obj;
