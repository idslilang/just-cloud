DROP DATABASE IF EXISTS `just`;

CREATE DATABASE  `just` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO `sys_menu` VALUES (9999, '系统官网', NULL, 'https://just4cloud.com/#/', -1, 'icon-guanwangfangwen', NULL, 9, '0', '0', '0', NULL, '2019-01-17 17:05:19', 'admin', '2020-03-11 23:52:57');
COMMIT;
