...
package com.cloud.just.auth.config;

import com.cloud.just.common.core.constant.CacheConstants;
import com.cloud.just.common.core.constant.SecurityConstants;
import com.cloud.just.common.security.component.JustWebResponseExceptionTranslator;
import com.cloud.just.common.security.service.JustClientDetailsService;
import com.cloud.just.common.security.service.JustUser;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) {
		JustClientDetailsService clientDetailsService = new JustClientDetailsService(dataSource);
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
		endpoints.allowedTokenEndpointRequestMethods(HttpMethod.GET, HttpMethod.POST).tokenStore(tokenStore())
				...
				.exceptionTranslator(new JustWebResponseExceptionTranslator());
	}
	...
	public TokenEnhancer tokenEnhancer() {
		return (accessToken, authentication) -> {
			...
			additionalInfo.put(SecurityConstants.DETAILS_USERNAME, justUser.getUsername());
			additionalInfo.put(SecurityConstants.DETAILS_DEPT_ID, justUser.getDeptId());
